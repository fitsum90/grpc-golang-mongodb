...
const (
	Product_AddProduct_FullMethodName = "/ProductService.Product/AddProduct"
)
...
func (c *productClient) AddProduct(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductResponse, error) {
...
func (UnimplementedProductServer) AddProduct(context.Context, *ProductRequest) (*ProductResponse, error) {
...
func _Product_AddProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServer).AddProduct(ctx, req.(*ProductRequest))
	}
